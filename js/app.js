...
const resources = {
  oxygen: {
    ...
    rate: "−2.3% /h",
    time: "~18h no nível atual",
    rec: [
      "seu treino às 21h usa +8% — considere às 18h",
      "aquecedor ligado desde 14h — acima do padrão",
      "pico em 40min coincide com seu horário habitual"
    ],
  ...
  water: {
    ...
    rate: "−0.8% /h",
    time: "~33h no nível atual",
    rec: [
      "consumo dentro do padrão do ciclo atual",
      "filtro de reaproveitamento operando a 94%",
      "reserva de segurança em nível adequado"
    ],
  ...
  food: {
    ...
    rate: "−3.1% /h",
    time: "~9h no nível atual",
    rec: [
      "jantar às 20h em risco — nível abaixo de 50%",
      "produção hidropônica do módulo D em crescimento",
      "redistribua reservas do módulo A"
    ],
